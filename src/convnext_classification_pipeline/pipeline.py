"""ImageNet-1k classification with the pinned ``timm/convnext_tiny.in12k_ft_in1k`` checkpoint (ConvNeXt-Tiny).
...
MODEL_REVISION = "aa096f03029c7f0ec052013f64c819b34f8ad790"
MODEL_LICENSE = "apache-2.0"
MODEL_KEY = "convnext-tiny-in12k"
...
@dataclass
class ConvNeXtClassificationPipeline:
    ...
    def fit(
        ...
        *,
    ...
    ) -> tuple[ConvNeXtClassificationPipeline, dict[str, Any]]:
        """Fine-tune the ConvNeXt model on custom classes 100% in-kernel."""
        import timm
        import torch
        ...
        if weights_path.is_file():
            ...
            backbone_sd = {k: v for k, v in sd.items() if not k.startswith("head.fc.")}
