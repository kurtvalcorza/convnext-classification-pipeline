...
DIMER pipeline scaffold for **timm/convnext_tiny.in12k_ft_in1k** — Image Classification.

| | |
|---|---|
| Upstream model | [`timm/convnext_tiny.in12k_ft_in1k`](https://huggingface.co/timm/convnext_tiny.in12k_ft_in1k) |
| Pinned revision | `aa096f03029c7f0ec052013f64c819b34f8ad790` (resolved 2026-09-12) |
