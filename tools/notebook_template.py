...
TEMPLATE = {
    ...
    "capability": "ImageNet-1k single-label image classification (1000 classes) and in-kernel fine-tuning using the pinned `timm/convnext_tiny.in12k_ft_in1k` weights",
    "intro": (
    ...
    "cells": [
        ...
        },
        {
            "md": (
                ...
                "container), `ConvNeXtClassificationPipeline.from_pretrained` loads the newly generated `model.safetensors` "
            ...
            "code": (
                "import csv\n\n"
                "reloaded_pipe = ConvNeXtClassificationPipeline.from_pretrained(weights_dir=ft_output_dir)\n\n"
