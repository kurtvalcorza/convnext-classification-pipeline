...
TEMPLATE = {
    ...
    "stem": "convnext_classification",
    "notebook_name": "convnext_classification_colab.ipynb",
    "profile": "TASK-INFERENCE",
    "pipeline_class": "ConvNeXtClassificationPipeline",
    "weights_key": "convnext-tiny-in12k",
    "runtime_imports": ["torch", "timm"],
    "title": "ConvNeXt-Tiny in12k_ft_in1k — DIMER image classification tutorial (standalone)",
    "badges": [
        (
            "GitHub",
            "https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white",
            "https://github.com/kurtvalcorza/convnext-classification-pipeline",
        ),
        (
            "Open In Colab",
            "https://colab.research.google.com/assets/colab-badge.svg",
            "https://colab.research.google.com/github/kurtvalcorza/convnext-classification-pipeline/blob/main/tutorials/convnext_classification_colab.ipynb",
        ),
        (
            "Hugging Face",
            "https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-timm%2Fconvnext__tiny.in12k__ft__in1k-ffcc4d?style=flat",
    ...
    "capability": "ImageNet-1k single-label image classification (1000 classes) using the pinned `timm/convnext_tiny.in12k_ft_in1k` weights",
    "intro": (
    ...
    "cells": [
        ...
        },
        {
            "md": (
                ...
                "ImageNet-1k validation set (whose upstream 84.186 % top-1 / 97.124 % top-5 at 224 px is quoted from the "
    ...
    "closing": (
        ...
        "ImageNet-1k, line drawings, medical or satellite imagery, and subjects near the image border (removed by the "
        "center crop) all degrade results in ways the pipeline does not detect. The pipeline provides no detection, "
        ...
        "how the top-1 score moves when the subject is moved toward the border of the frame.\n\n"
        "## References\n\n"
        "- Repository README: https://github.com/kurtvalcorza/convnext-classification-pipeline/blob/main/README.md\n"
        "- Repository model card: https://github.com/kurtvalcorza/convnext-classification-pipeline/blob/main/MODEL_CARD.md\n"
        "- Weight provenance: https://github.com/kurtvalcorza/convnext-classification-pipeline/blob/main/docs/WEIGHTS.md\n"
