...
|---|---|---|---|---|---|
| 2026-09-14 | `98fa3d8` / `79eaced9ad68` | Kaggle T4 (`kurtvalcorza/dimer-nb2-convnext-classification` v1) | Default sample path | 178.7 s | **PASSED** — 10/10 ok code cells executed cleanly, 8 files, 114 MB staged |
...
real `hf_hub_download` fetch of all three manifest entries into a fresh `weights/convnext-tiny-in12k/` has not been
